...
Algoritmo: Heat equation en cython optimizado (MAIN)
'''
...
from cython2 import init_fields, write_field, iterate
...
def main(input_file='bottle.dat', a=0.5, dx=0.1, dy=0.1, 
    ...
    #print("Tiempo de ejecución Cython Optimizado{0} s".format(t1-t0))
